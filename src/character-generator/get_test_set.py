...
class ImageChar():
    ...
    def save_single(self, dir, index):
        # random.shuffle(self.single_chars)
        tmp_mapping = {}
        i = 0
        for char in self.single_chars:
...
def generate_test_set(part=None, level=None):
    dir = 'output/test/'+part
...
if __name__=='__main__':
    generate_test_set(part='seen', level='level1')
    generate_test_set(part='unseen', level='level2')
